...
# Importing datasets
Lang2_dataset = pd.read_csv('datasets/english_dataset.csv').values
Lang2_sentences = []
for i in Lang2_dataset:
  Lang2_sentences.append(i[0])

Lang1_dataset = pd.read_csv('datasets/hinglish_datset.csv')
Lang1_sentences = []
for i in Lang1_dataset.values:
